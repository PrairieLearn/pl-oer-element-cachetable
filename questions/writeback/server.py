...
def generate(data):
    ...
    if data["correct_answers"]["cache_access"][0]["hit"]:
        data["correct_answers"]["ans"] = data["correct_answers"]["cache_access"][0][
            "data"
        ]
    elif not data["correct_answers"]["cache_access"][0]["writeback"]:
